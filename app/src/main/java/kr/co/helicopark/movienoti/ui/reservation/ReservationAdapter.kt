...
class ReservationAdapter(private val onItemClickListener:(personalReservation:PersonalReservationMovie)->Unit) : ListAdapter<PersonalReservationMovie, ReservationAdapter.ViewHolder>(MovieDiffUtil) {
    ...
    inner class ViewHolder(private val binding: ItemReservationListBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind() {
            binding.clReservationItem.setOnClickListener {
